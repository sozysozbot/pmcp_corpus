...
type Source = "ゲムマ2024春広報処コメント" | "製造業者紹介チラシ" | "かるたスライド" | "プロパガンダかるた" | "筆兵無傾バランスゲームのカード" | "フォントテスト用パングラム" | "筆兵無傾AdC広報処コメント" | "2023年5月ゲムマ収録漏れ資料" | "我々の遊戯" | "パングラム2" | "【羅古論】目録" | "PMCF ポスター" | "机戦紹介スライド" | "連盟サイト「遊戯の道具」" | "連盟サイト「駒・役と点数」" | "机戦戦術研究テキスト" | "レヴェン・法・タムツイ" | "我々の文化オープニング" | "我々の文化3机戦の歴史" | "2021年始ご挨拶" | "机戦指し始め" | "紙机戦の書" | "諸机戦" | "踏越え論" | "異世界に転生したけど日本語が通じなかった" | "連盟員速習" | "国際母語の日" | "アイル統一机戦書" | "アイル統一机戦書記譜例" | "国際共産歌詞" | "冠光歌詞" | "改良版アリス" | "東島通商語入門" | "パングラム" | "地震速報" | "不信心者" | "クレオール言語に関する一考察" | "あいさつ" | "PMCFショーケース";

const is_valid_source = (source: string): source is Source => {
  return ["ゲムマ2024春広報処コメント","製造業者紹介チラシ","かるたスライド","プロパガンダかるた","筆兵無傾バランスゲームのカード","フォントテスト用パングラム","筆兵無傾AdC広報処コメント","2023年5月ゲムマ収録漏れ資料","我々の遊戯","パングラム2","【羅古論】目録","PMCF ポスター","机戦紹介スライド","連盟サイト「遊戯の道具」","連盟サイト「駒・役と点数」","机戦戦術研究テキスト","レヴェン・法・タムツイ","我々の文化オープニング","我々の文化3机戦の歴史","2021年始ご挨拶","机戦指し始め","紙机戦の書","諸机戦","踏越え論","異世界に転生したけど日本語が通じなかった","連盟員速習","国際母語の日","アイル統一机戦書","アイル統一机戦書記譜例","国際共産歌詞","冠光歌詞","改良版アリス","東島通商語入門","パングラム","地震速報","不信心者","クレオール言語に関する一考察","あいさつ","PMCFショーケース"].includes(source);
}
